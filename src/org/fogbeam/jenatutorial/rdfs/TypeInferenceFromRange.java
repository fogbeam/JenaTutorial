...
public class TypeInferenceFromRange
{

	public static void main( String[] args )
	{
		// load some data that uses RDFS
		Model data = FileManager.get().loadModel("file:data/input/turtle/ex15-data.ttl");
		...
		queryString = "SELECT ?x ?z WHERE { ?x <http://www.example.org/example#hasCommander> ?z }";
		...
		queryString = "SELECT ?x WHERE { ?x <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://www.example.org/example#Captain> }";
