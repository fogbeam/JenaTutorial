...
public class OWL_InverseOf
{

	public static void main( String[] args )
	{
		// load some data that uses RDFS
		Model data = FileManager.get().loadModel("file:data/input/turtle/ex19-data2.ttl");
		...
		queryString = "SELECT ?x ?z WHERE { ?x <http://www.example.org/example#possessedBy> ?z }";
